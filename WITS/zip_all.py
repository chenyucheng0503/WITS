...
def unzip_file(path):
    ...
    for filename in filenames:
        ...
        if len(file_str) != 18:
            shutil.move(filepath, r"C:/Users/17313/Downloads/第二阶段/重复数据")
            print("存在重复数据")
            continue
        ...
        newfilepath = os.path.join(path, "解压后文件")
        ...
        if os.path.exists(filepath):  # 移动原先压缩包
            shutil.move(filepath, r"C:/Users/17313/Downloads/第二阶段/原始压缩包")
...
if __name__ == '__main__':
    path = r"C:/Users/17313/Downloads/第二阶段"  # 获取当前路径
    unzip_file(path)
